...
public class tietokanta extends Application {
    ...
    public void start(Stage stage) throws IOException {
       ...
       TableView tableView = new TableView();
        ...
        TableColumn<person, String> column4 = new TableColumn<>("rivi");
        column4.setCellValueFactory(new PropertyValueFactory<>("rivi"));
        TableColumn<person, String> column5 = new TableColumn<>("tuhkauspaikka");
        column5.setCellValueFactory(new PropertyValueFactory<>("tuhkausPaikka"));
        TableColumn<person, String> column6 = new TableColumn<>("hautauspäivämäärä");
        column6.setCellValueFactory(new PropertyValueFactory<>("hautausPvm"));

        tableView.getColumns().addAll(column1, column2, column3, column4, column5,column6);

        tableView.getItems().add(new person("paavo", "arkku", "saapasmäki", "3","derp", "2002" ));
            ...
            public void handle(ActionEvent event){
                ...
                saveButton.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent actionEvent) {
                       tableView.getItems().add(new person(nimiKenttä.getText(),hautaustapaKenttä.getText(),paikkaKenttä.getText(),riviKenttä.getText(),tuhkausPaikkaKenttä.getText(),hautausPvmKenttä.getText()));
                       nimiKenttä.setText("");
